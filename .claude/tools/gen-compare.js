...
var APP_CSS = [
  ...
  '.dapp .dslot.empty{border-color:var(--edge)}',
...
function toolMain(openTag, index, order, pairCount) {
  ...
  '        <li class="dslot empty"><span><span class="lbl">מכשיר א׳</span><span class="nm">בחרו דגם</span></span></li>\n' +
  '        <li class="dslot empty"><span><span class="lbl">מכשיר ב׳</span><span class="nm">בחרו דגם</span></span></li>\n' +
